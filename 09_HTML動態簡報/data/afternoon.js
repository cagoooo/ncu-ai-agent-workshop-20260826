window.DYNAMIC_DECK_DATA = {
  ...
  "slides": [
    ...
    },
    {
      ...
      "section": "從助理走向 Agent",
      "notes": "阿凱老師的『人生交往學』選型心法（下午場核心概論）：\n1. Gemini Antigravity 就像熱血年輕弟弟，Flash 3.6 到 3.7 速度快了人家 20 倍以上，給指令秒回且衝勁十足，但缺點是一頭熱無法持久，適合衝刺型任務。\n2. Claude 就像成熟穩重的伴侶進入婚姻生活，極度沉穩、代碼輸出讓人完全放心不用擔心出錯，但沒有突發驚喜，Token 燒完就得等下週重置。\n3. Codex 介於兩者之間且變化性最大，個性可切換 1.5 倍速，最讓人喜歡的是常有機會被重置、獲得 100% 回檔驚喜讓你繼續接關！\n選 Agent 不是看名氣，而是依當下的任務緊急度、複雜度與回檔需求挑選合適的夥伴。\n\n[Sources]\n- https://www.anthropic.com/news/claude-sonnet-5\n- https://www.anthropic.com/news/claude-opus-4-8\n- https://www.anthropic.com/news/claude-fable-5-mythos-5\n- https://openai.com/index/gpt-5-6/\n- https://developers.openai.com/api/docs/models/gpt-5.6-luna\n- https://ai.google.dev/gemini-api/docs/models/gemini-3.6-flash\n[/Sources]",
