...
- 上午場：Typeless、ChatGPT／Codex Voice、Gemini Notebook、Gem、Canvas 與網站部署實作（40 頁）
...
- `09_HTML動態簡報/index.html`：上午 40 頁、下午 50 頁的 HTML 原生文字場景，預留 HyperFrames／Remotion 動態化結構
