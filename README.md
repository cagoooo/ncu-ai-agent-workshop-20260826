...
- 上午場：Typeless、ChatGPT／Codex Voice、Gemini Notebook、Gem、Canvas 與網站部署實作（44 頁）
- 下午場：Antigravity、Codex、Agent Skills、資料分析實戰與 Agent 時代人生反思（52 頁；含手機遠端控制更新）
...
- `09_HTML動態簡報/index.html`：上午 44 頁、下午 52 頁的 HTML 原生文字場景，含 Antigravity Remote Control 更新，預留 HyperFrames／Remotion 動態化結構
