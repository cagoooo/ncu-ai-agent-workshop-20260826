const BUILD_VERSION = "2026.08.18.11";
...
const PRECACHE = [
  ...
  "./09_HTML動態簡報/assets/favicon-32x32.png?v=" + BUILD_VERSION,
  "./09_HTML動態簡報/assets/apple-touch-icon.png?v=" + BUILD_VERSION,
  "./09_HTML動態簡報/assets/icon-192.png?v=" + BUILD_VERSION,
  "./09_HTML動態簡報/assets/icon-512.png?v=" + BUILD_VERSION,
  "./09_HTML動態簡報/assets/icon-192-maskable.png?v=" + BUILD_VERSION,
  "./09_HTML動態簡報/assets/icon-512-maskable.png?v=" + BUILD_VERSION,
  "./09_HTML動態簡報/assets/og-dynamic.png?v=" + BUILD_VERSION,
  "./09_HTML動態簡報/manifest.webmanifest?v=" + BUILD_VERSION,
